...
augments = A.Compose([
    A.RandomSizedCrop(min_max_height=(512, 1024), height=1024, width=1024, w2h_ratio=1.0, interpolation=1,
                      always_apply=False, p=p_crop),
    A.OneOf([
        ...
        A.MultiplicativeNoise(multiplier=(0.8, 1.2), per_channel=True, elementwise=True, always_apply=False,
                              p=w_noise_multiplicative),
    ...
    A.OneOf([
        A.GridDropout(ratio=0.4, unit_size_min=None, unit_size_max=None, holes_number_x=None, holes_number_y=None,
                      shift_x=0, shift_y=0, random_offset=True, fill_value=0, mask_fill_value=None, always_apply=False,
                      p=w_obs_griddropout),
    ...
    A.OneOf([
        ...
        A.HueSaturationValue(hue_shift_limit=10, sat_shift_limit=30, val_shift_limit=30, always_apply=False,
                             p=w_color_hsv),
        ...
        A.RandomBrightnessContrast(brightness_limit=0.3, contrast_limit=0.3, brightness_by_max=True, always_apply=False,
                                   p=w_color_brightnesscontrast),
    ...
    A.OneOf([
        ...
        A.GridDistortion(num_steps=7, distort_limit=0.4, interpolation=1, border_mode=4, value=None, mask_value=None,
                         always_apply=False, p=w_geometric_griddistortion),
        A.OpticalDistortion(distort_limit=0.4, shift_limit=0.4, interpolation=1, border_mode=4, value=None,
                            mask_value=None, always_apply=False, p=w_geometric_opticaldistortion),
        A.Perspective(scale=(0.05, 0.2), keep_size=True, pad_mode=0, pad_val=0, mask_pad_val=0, fit_output=False,
...
def augments_dinov2(image_size):
    return A.Compose([
        ...
        # Noise block
        A.OneOf([
            A.GaussNoise(var_limit=(10, 100), mean=0, per_channel=True, p=1),
            # Adjusted for more subtle and realistic noise impact
            A.ISONoise(color_shift=(0.01, 0.05), intensity=(0.1, 0.5), p=1),
            # Lowered parameters to simulate more accurate digital camera noise
        ...
        A.OneOf([
            A.ToGray(p=w_color_gray),
            A.HueSaturationValue(hue_shift_limit=10, sat_shift_limit=20, val_shift_limit=20, always_apply=False,
                                 p=w_color_hsv),
            ...
            A.RandomBrightnessContrast(brightness_limit=0.2, contrast_limit=0.2, brightness_by_max=True,
                                       always_apply=False, p=w_color_brightnesscontrast),
