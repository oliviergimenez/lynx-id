...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--use_image_queue',
        action='store_true',
        help='Pre-load python detection/run_detector_batch.py $LYNX_PROJECT/data_pipeline/megadetector/md_v5a.0.0.pt "$ALL_CCFRSCRATCH/datasets/extracted/Deep learning lynx - data/0_dataset_raw/0_dataset_Marie_OCS/OCS_B310" $LYNX_PROJECT/data_pipeline/megadetector/res.json --output_relative_filenames --recursive --checkpoint_frequency 10000 --quietimages, may help keep your GPU busy; does not currently support ' + \
